...
> Discord YouTube notifier bot, new video alerts 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

🔔 &nbsp;**Instant alerts** — new video notification in seconds

📺 &nbsp;**Multiple channels** — monitor unlimited YouTube channels

🖼️ &nbsp;**Rich embeds** — thumbnail, title, description, views

🎭 &nbsp;**Custom message** — add your own text to notifications

📋 &nbsp;**Watchlist** — manage all subscriptions in one place

🔕 &nbsp;**Quiet hours** — pause notifications at certain times
